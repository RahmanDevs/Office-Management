...
from teachers.models import Teacher, University, Department

aqis=Department.objects.filter(name_en='Department of Al-Quran & Islamic Studies').first()
islamic_university=University.objects.filter(short_name_en='IU').first()
...
TEACHER_DATA = [
    {
        ...
        'short_name_en':"SI",
        # get designation from model choices
        'designation': Teacher.DESIGNATION_CHOICES[0][0],
        'university': islamic_university,
        'department': aqis,
    ...
    {
        'full_name_en': 'Dr. Md. Aktaruzzaman',
        'full_name_uni': 'ড. মোঃ আখতারুজ্জামান',
        'full_name_ansi': 'W. †gvt AvLZviæ¾vgvb',
        'short_name_en':"AKZ",
        'designation': Teacher.DESIGNATION_CHOICES[0][0],
        'university': None,
        'department': None,
        ...
        'tin_number': None,
        'data_of_birth': None,
        'profile_picture': 'profile_pictures/Dr._Md._Aktaruzzaman.jpg',
    },
